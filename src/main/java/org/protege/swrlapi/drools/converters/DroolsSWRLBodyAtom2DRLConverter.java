...
import org.protege.swrlapi.converters.TargetRuleEngineSWRLBodyAtomWithVariableNamesConverter;
...
import org.protege.swrlapi.drools.DroolsSWRLBuiltInInvoker;
		...
		TargetRuleEngineSWRLBodyAtomWithVariableNamesConverter<String>
{
	...
	public DroolsSWRLBodyAtom2DRLConverter(SWRLRuleEngineBridge bridge)
	{
		...
		this.bodyAtomArgumentConverter = new DroolsSWRLBodyAtomArgument2DRLConverter(this.literalConverter);
